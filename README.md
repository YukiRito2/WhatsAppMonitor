...
3. **ChromeDriver**: Descarga [ChromeDriver](https://googlechromelabs.github.io/chrome-for-testing/). compatible con tu versión de Chrome e instálalo en `C:\SeleniumDrivers\`.
